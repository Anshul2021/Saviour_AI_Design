...
function injectSkeletonLayout(container, pageType) {
  ...
  const tabbarHTML = `
    ...
    <div class="c-tabbar" style="border-top: 1px solid var(--color-divider); box-sizing: border-box; flex-shrink: 0; background-color: var(--color-surface); height: 64px; display: flex; justify-content: space-around; align-items: center; width: 100%;">
      <div class="c-shimmer" style="height: 36px; width: 60px; border-radius: var(--radius-sm);"></div>
      <div class="c-shimmer" style="height: 36px; width: 60px; border-radius: var(--radius-sm);"></div>
      <div class="c-shimmer" style="height: 36px; width: 60px; border-radius: var(--radius-sm);"></div>
    </div>
  `;
  ...
  if (pageType === 'pantry') {
    ...
    container.innerHTML = `
      ...
      <!-- Home indicator -->
      <div class="c-home-indicator" style="width: 100%; display: flex; justify-content: center; align-items: center; padding: 8px 0; box-sizing: border-box; flex-shrink: 0; background-color: var(--color-base);">
        <div class="home-indicator-bar" style="width: 134px; height: 5px; background-color: var(--color-text-primary); border-radius: 100px; opacity: 0.8;"></div>
      </div>
    `;
  } else if (pageType === 'grocery') {
    ...
    try {
      ...
      if (componentName === 'status-bar') {
        ...
        el.innerHTML = `
          ...
          <div class="c-tabbar" role="navigation" style="background-color: var(--color-surface);">
            <a href="home.html" class="c-tabbar__item" data-tab="home">
              <div class="c-tabbar__icon">
            ...
            <a href="grocery.html" class="c-tabbar__item" data-tab="grocery">
              <div class="c-tabbar__icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="profile.html" class="c-tabbar__item" data-tab="profile">
              <div class="c-tabbar__icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
